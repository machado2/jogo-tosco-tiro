class EngineFlame extends Entity {
    ...
    update() { this.x += this.velX; this.y += this.velY; if (this.mesh && this.mesh.material) this.mesh.material.alpha *= 0.88; if (--this.life <= 0) this.destroy(); this.updateMeshPosition(); this.updateBodyFromEntity(); }
}

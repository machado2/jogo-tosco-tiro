...
use jogo_tosco_tiro::core::{GamePhase, Score, FrameCounter, EnemyPopulation, Shake, Muted};
use jogo_tosco_tiro::input::CursorPos;
use jogo_tosco_tiro::gameplay::player::Player;
use jogo_tosco_tiro::gameplay::components::{Collider, Health, Charge};
use jogo_tosco_tiro::gameplay::enemy::{WaveManager, WaveConfig};
use jogo_tosco_tiro::effects::Trail;
use jogo_tosco_tiro::rendering::{spawn_ship_visual, spawn_engine_glow, ShipBounds};
...
fn setup(
    ...
    let mut player_entity = commands.spawn((
        ...
        Player,
        Collider { w: SIZE_PLAYER.x, h: SIZE_PLAYER.y }, // Will be adjusted after ship mesh is built
        ...
        Name::new("Player"),
        jogo_tosco_tiro::gameplay::player::PlayerCooldowns { shoot: Timer::from_seconds(0.0, TimerMode::Once), special: Timer::from_seconds(0.0, TimerMode::Once) },
    ));

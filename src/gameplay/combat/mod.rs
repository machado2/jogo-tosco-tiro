...
use crate::constants::{SIZE_MISSILE, SCREEN_WIDTH, SCREEN_HEIGHT, POINTS_ENEMY, POINTS_METEOR, POINTS_SPECIAL};
use crate::gameplay::components::{Collider, Velocity, TrailTimer, LaserFollowPlayer, Health};
use crate::gameplay::player::Player;
use crate::core::{GamePhase, Score, Shake, Muted};
...
fn emit_enemy_destruction_burst(
    ...
    for _ in 0..25 {
        ...
        commands.spawn((
            ...
            crate::effects::Particle2D { vel: Vec2::new(vx, vy), life, total: life, start: color * 1.5, end: Color::rgba(0.2, 0.0, 0.0, 0.0), spin: rng.gen_range(-8.0..8.0) },
        ));
    }
    // Fast small sparks
    for _ in 0..20 {
        ...
        commands.spawn((
            ...
            crate::effects::Particle2D { vel: Vec2::new(vx, vy), life, total: life, start: color * 1.8, end: Color::rgba(0.0, 0.0, 0.0, 0.0), spin: rng.gen_range(-12.0..12.0) },
        ));
    }
}
...
fn emit_bullet_impact_burst(
    ...
    for _ in 0..12 {
        ...
        commands.spawn((
            ...
            crate::effects::Particle2D { vel: Vec2::new(vx, vy), life, total: life, start: base_color * 1.3, end: Color::rgba(0.0, 0.0, 0.0, 0.0), spin: rng.gen_range(-10.0..10.0) },
        ));
    }
